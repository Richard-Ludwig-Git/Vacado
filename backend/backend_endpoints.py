...
def change_request(request_id: int = Form(),
    ...
    data_handling.update_request(request_id, duration, origin_city, transportation_type, max_travel_time, theme, accommodation, budget, special_need)
