...
def create_new_request(duration: int = Form(),
    ...
    vacation_request = RequestClass(duration=duration, theme=theme, accommodation_type=accommodation, budget=budget)
    ...
    data_handling.store_response(openai_response, request_id)
